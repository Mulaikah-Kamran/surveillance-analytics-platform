...
These seven ADRs were locked during project planning (Phase 0) and are
reproduced here from the Freeze Document, Section 18, as the
authoritative historical record within the repository itself.
